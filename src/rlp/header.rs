...
use crate::rlp::error::Result;

use super::{decode::static_left_pad, encode::to_be_bytes_trimmed, error::Error, EMPTY_LIST_CODE, EMPTY_STRING_CODE};
...
impl Header {
    /// Decode an RLP header from the given buffer
    /// Return an error if the buffer is too short or the header is invalid
    #[inline]
